...
var FBservicesService = /** @class */ (function () {
    function FBservicesService(router, toastController, alertController, navCtrl) {
        this.router = router;
    ...
    FBservicesService.prototype.getPesajeCompra = function (idProveedor) {
        ...
        firebase
            ...
            console.log("metodo getPesajeCompra" + _this.pesajeCompraLista.length);
            return _this.pesajeCompraLista;
        });
    };
    //Metodos para los::::::::::::::::::::::ANTICIPOS
    //Confirmar pesajes
