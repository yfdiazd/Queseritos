...
var FBservicesService = /** @class */ (function () {
    ...
    FBservicesService.prototype.crearProdcuto = function (codigoProducto, descripcionProducto) {
    ...
    FBservicesService.prototype.updateProdcuto = function (idProducto, codigoProducto, descripcionProducto) {
        this.usuarioUid = firebase.auth().currentUser.uid;
        this.idProducto = this.idGenerator();
        firebase
            .database()
    ...
    FBservicesService.prototype.getPesajeCompra = function () {
        var _this = this;
        //this.usuarioUid = firebase.auth().currentUser.uid;
        firebase
            .database()
            ...
            console.log("metodo lelelel " + _this.pesajeCompraLista.length);
            return _this.pesajeCompraLista;
        });
    };
    FBservicesService.prototype.updatePesajeCompra = function (idPesaje, pesoUp) {
        firebase
            .database()
    ...
    FBservicesService.prototype.getCompras = function () {
        var _this = this;
        firebase
            .database()
            .ref("usuario/" + this.usuarioUid + "/compras/" + "/pesajeCompra")
            ...
            snapshot.forEach(function (element) {
                if (element.val().estado == 1) {
                    _this.listaCompras.push(element.val());
                }
            });
            return _this.listaCompras;
        });
    };
    //Confirmar pesajes
    FBservicesService.prototype.agregarConfirmaPesaje = function (idPesajeCompra, idEstadoProducto, cantidadEstado, costoKilo, costoTotalEstado) {
        this.usuarioUid = firebase.auth().currentUser.uid;
    ...
    FBservicesService.prototype.editarConfirmaPesaje = function (id, idEstadoProducto, cantidadEstado, costoKilo, costoTotalEstado) {
        this.usuarioUid = firebase.auth().currentUser.uid;
        firebase
            .database()
            .ref("usuario/" + this.usuarioUid + "/compras/confirmarPesajeCompra/" + this.idConfirmarPesajeCompra)
    ...
    FBservicesService.prototype.eliminarConfirmaPesaje = function (id) {
        this.usuarioUid = firebase.auth().currentUser.uid;
        firebase
            .database()
            .ref("usuario/" + this.usuarioUid + "/compras/confirmarPesajeCompra/" + this.idConfirmarPesajeCompra)
    ...
    FBservicesService.prototype.getLoteCompraProveedor = function (idProveedor) {
        var _this = this;
        firebase
            .database()
            .ref("usuario/" + this.usuarioUid + "/compras/pesajeCompra")
            .on("value", function (snapshot) {
            _this.pesajeCompraListaPorProveedor = [];
            _this.ultimoLote.forEach(function (element) {
                var sumaB = 0;
                var sumaP = 0;
                var lotelocal = "";
                var obj;
                snapshot.forEach(function (element2) {
                ...
                _this.pesajeCompraListaPorProveedor.push(obj);
            });
            console.log("metodo get pesaje compra: " + _this.pesajeCompraLista.length);
            return _this.pesajeCompraLista;
        });
    ...
    FBservicesService.prototype.registrarAnticiposApesajeCompra = function (idprovedor, idPesajeCompra, idTipoAnticipo, valorAnticipo, archivo) {
        this.usuarioUid = firebase.auth().currentUser.uid;
    ...
    FBservicesService.prototype.getAticiposPesajeCompra = function (idPesajeComrpa) {
        var _this = this;
        this.usuarioUid = firebase.auth().currentUser.uid;
        firebase
            .database()
            ...
            snapshot.forEach(function (element) {
                if (element.val().idPesajeCompra == idPesajeComrpa) {
                    _this.anticiposPesajeCompraLista.push(element.val());
                }
            });
        });
