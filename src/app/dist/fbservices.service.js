...
var FBservicesService = /** @class */ (function () {
    ...
    FBservicesService.prototype.registrarAnticiposApesajeCompra = function (idProveedor, idPesajeCompra, idTipoAnticipo, valorAnticipo, archivo) {
        this.usuarioUid = firebase.auth().currentUser.uid;
    ...
    FBservicesService.prototype.uploadImage = function (imageURI) {
        var _this = this;
    ...
    FBservicesService.prototype.encodeImageUri = function (imageUri, callback) {
