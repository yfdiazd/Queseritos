...
var routes = [
    ...
    { path: 'creartipostrueque', loadChildren: function () { return Promise.resolve().then(function () { return require('./formularios/creartipostrueque/creartipostrueque.module'); }).then(function (m) { return m.CreartipostruequePageModule; }); } },
    ...
    { path: 'crearpesajecompra', loadChildren: function () { return Promise.resolve().then(function () { return require('./formularios/crearpesajecompra/crearpesajecompra.module'); }).then(function (m) { return m.CrearpesajecompraPageModule; }); } },
    { path: 'crearanticipos', loadChildren: function () { return Promise.resolve().then(function () { return require('./formularios/crearanticipos/crearanticipos.module'); }).then(function (m) { return m.CrearanticiposPageModule; }); } },
    ...
    { path: 'cardcompradetallada', loadChildren: function () { return Promise.resolve().then(function () { return require('./cards/cardcompradetallada/cardcompradetallada.module'); }).then(function (m) { return m.CardcompradetalladaPageModule; }); } },
    ...
    { path: 'cardlotes', loadChildren: function () { return Promise.resolve().then(function () { return require('./cards/cardlotes/cardlotes.module'); }).then(function (m) { return m.CardlotesPageModule; }); } },
    {
        path: 'detallelote',
