...
var CrearpesajecompraPage = /** @class */ (function () {
    ...
    CrearpesajecompraPage.prototype.removeRegister = function (index) {
        this.listaBultos.splice(index, 1);
    };
    CrearpesajecompraPage.prototype.agregarBultoLista = function () {
        this.presentAlertRadio();
    };
    CrearpesajecompraPage.prototype.presentAlertRadio = function () {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (value) {
                                        if (value != 0) {
                                            ...
                                            console.log("Bulto: " + _this.bultoObj.bulto);
                                            console.log("Peso: " + _this.bultoObj.peso);
                                            _this.listaBultos.push(_this.bultoObj);
                                            console.log("lista: ", _this.listaBultos);
    ...
    CrearpesajecompraPage.prototype.eliminarBulto = function (index) {
        this.listaBultos.splice(index);
        this.numbulto--;
    };
    CrearpesajecompraPage.prototype.edit = function (index) {
        this.listaBultos.forEach(function (element) {
            if (element.index == index) {
                console.log("Si lo encontro", element.peso);
            }
        });
    };
    CrearpesajecompraPage.prototype.contarPeso = function () {
        var _this = this;
        this.contadorPeso = 0;
        this.listaBultos.forEach(function (element) {
    ...
    CrearpesajecompraPage.prototype.guardar = function () {
        ...
        this.FB.agregarPesaje(this.id, this.tipoQueso, this.listaBultos.length, this.contadorPeso, this.listaBultos);
        this.listaBultos = [];
    };
